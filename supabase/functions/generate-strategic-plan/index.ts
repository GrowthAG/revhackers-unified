...
Retorne um JSON VÁLIDO EXATAMENTE NESTE FORMATO, e preencha TODOS os arrays com TÁTICAS AVANÇADAS, inferidas das respostas:
{
  ...
  "signals": [
    { "type": "positive"|"negative"|"neutral", "headline": "Título curto e impactante (2-4 palavras, ex: Cadência Caótica)", "text": "Citação ou sinal CLARO E ESPECÍFICO do cliente (Jamais genérico)", "impact": "Impacto real e numérico na operação" }
  ],
  "risks": [
    { "severity": "high"|"medium"|"low", "headline": "Título da causa raiz (2-4 palavras, ex: Ausência de Governança)", "text": "Risco letal ATUAL baseado no relato", "mitigation": "Tática avançada da RevHackers para resolver. Exclua buzzwords como sinergia." }
  ],
  "decisions": [
...
CRITICAL_RULE_SIGNALS_LANGUAGE: Nos arrays 'signals', 'risks' e 'decisions', os campos 'headline' DEVEM ser títulos curtos, formais e de impacto (ex: "Cadência Caótica", "Cegueira de Dados", "Processo Quebrado"). Os campos de texto descritivo DEVEM ser escritos em linguagem natural, fluída e humana estruturando uma frase completa (ex: "A cadência de emails está caótica e aumentando o ghosting"). É EXPRESSAMENTE PROIBIDO retornar nomes de variáveis em snake_case ou chaves de sistema vazadas do contexto (ex: PROIBIDO retornar "revops_flow_cadencia = caotico"). Traduza o dado técnico para o problema real na linguagem de negócios do cliente.
