...
insert into storage.buckets (id, name, public)
values ('revhackers-uploads', 'revhackers-uploads', true)
on conflict (id) do nothing;
...
create policy "Public Access"
  ...
  using ( bucket_id in ('blog-covers', 'revhackers-uploads') );
...
create policy "Authenticated Upload"
  ...
  to authenticated
  with check ( bucket_id in ('blog-covers', 'revhackers-uploads') );
