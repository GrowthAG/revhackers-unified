            ...
            items.push(
              <div key={j} className="flex gap-6 mb-8 last:mb-0 group/item">
                <div className="shrink-0 pt-1.5">
                  <span className={`font-mono text-xxs tabular-nums px-2 py-1 border ${isDark ? 'border-zinc-800 text-zinc-500' : 'border-zinc-100 text-zinc-400'} rounded-sm`}>
                    {number.padStart(2, '0')}
                  </span>
                </div>
          ...
          <div className="mb-48 relative">
            ...
            <div className="absolute -top-16 left-0 flex flex-col gap-2">
              <div className="flex items-center gap-4">
                <div className="bg-black text-3xs font-mono text-white px-3 py-1 font-bold">PROJECT_PHASE_01</div>
                <div className="h-[1px] w-48 bg-zinc-900/10"></div>
                <span className="font-mono text-3xs text-zinc-400 uppercase tracking-widest">AIRCRAFT_GRADE_PRECISION</span>
              </div>
              <h4 className="font-mono text-3xl md:text-4xl text-zinc-100 font-bold -mt-4 opacity-50 pointer-events-none select-none">SYSTEM_DIAGNOSIS</h4>
            </div>
            ...
            {caseData.quote && (
              <div className="relative pt-20 border-t-[1.5px] border-zinc-900">
                <div className="absolute -top-4 left-0 bg-black px-4 py-1">
                  <span className="font-mono text-xxs uppercase tracking-widest font-bold text-white italic">Client_Testimony</span>
                </div>
                ...
                <div className="mt-16 flex items-center justify-end">
                  ...
                  <span className="font-mono text-3xs text-zinc-300 ml-4 italic uppercase">Verified_Record</span>
                </div>
              </div>
            )}
            ...
            <div className="space-y-32">
              {caseData.techStack && caseData.techStack.length > 0 && (
                <div className="bg-white border-[1.5px] border-zinc-900 p-16 relative overflow-hidden group shadow-[20px_20px_0px_rgba(0,0,0,0.01)]">
                  <div className="absolute top-4 left-4 font-mono text-4xs text-zinc-300 uppercase tracking-widest">Stack_Validation</div>
              ...
              <div className="pt-32 border-t-2 border-dashed border-zinc-200 relative">
                ...
                <h3 className="font-mono text-tiny text-zinc-400 uppercase tracking-[0.6em] mb-12 font-bold italic">Corporate_Blueprint_2026</h3>
