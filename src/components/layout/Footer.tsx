        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex space-x-4 mb-8">
                <a href="https://www.linkedin.com/company/34579614/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-gray-600 rounded flex items-center justify-center text-gray-300 hover:text-revgreen hover:border-revgreen transition-colors duration-300">
                  <Linkedin size={20} />
                </a>
                <a href="https://www.instagram.com/revhackers.com.br/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-gray-600 rounded flex items-center justify-center text-gray-300 hover:text-revgreen hover:border-revgreen transition-colors duration-300">
                  <Instagram size={20} />
                </a>
                <a href="https://www.youtube.com/@RevHackersTV" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-gray-600 rounded flex items-center justify-center text-gray-300 hover:text-revgreen hover:border-revgreen transition-colors duration-300">
                  <Youtube size={20} />
                </a>
                <a href="mailto:contato@revhackers.com.br" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-gray-600 rounded flex items-center justify-center text-gray-300 hover:text-revgreen hover:border-revgreen transition-colors duration-300">
                  <Mail size={20} />
                </a>
              </div>
            </div>
          ...
          <div className="border-t border-revgreen mt-16 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap justify-center md:justify-end gap-x-8 gap-y-4">
              ...
              <a href="https://growthfunnels.com.br/" target="_blank" rel="noopener noreferrer" className="text-gray-400 text-sm hover:text-white transition-colors duration-200">
                Growth Funnels
              </a>
            </div>
          </div>
