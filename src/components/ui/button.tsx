...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-none text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-revgreen text-black hover:bg-black hover:text-revgreen border border-transparent hover:border-revgreen transition-colors duration-200",
        destructive:
          "bg-red-600 text-white hover:bg-red-700",
        outline:
          "border border-zinc-200 bg-transparent text-black hover:bg-black hover:text-white hover:border-black transition-colors duration-200",
        secondary:
          "bg-zinc-100 text-black hover:bg-zinc-200",
        ghost: "hover:bg-zinc-100 hover:text-black",
        link: "text-black underline-offset-4 hover:underline hover:text-revgreen",
      },
      size: {
        default: "h-12 px-6 py-3",
        sm: "h-9 px-4 text-xs uppercase tracking-wider",
        lg: "h-14 px-8 text-sm uppercase tracking-[0.2em] font-bold",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
