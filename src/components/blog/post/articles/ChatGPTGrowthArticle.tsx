  ...
  return (
    <article className="w-full mx-auto">
      <div className="prose prose-base md:prose-lg lg:prose-xl max-w-none text-zinc-900 leading-relaxed">
        ...
        {/* Intro + Stats */}
        <div className="mb-16">
          <h2 id="intro" className="font-bold tracking-tight text-zinc-900 mt-0">O Multiplicador de Produtividade</h2>
          ...
          <div className="flex flex-col md:flex-row gap-8 my-10 border-y border-zinc-200 py-8 not-prose">
            <div className="flex-1">
              ...
              <div className="text-xs text-zinc-500 uppercase tracking-widest font-medium">Velocidade de Criação</div>
            </div>
            <div className="flex-1 md:border-l md:border-zinc-200 md:pl-8">
              <div className="text-4xl font-bold text-black mb-1">Zero</div>
              <div className="text-xs text-zinc-500 uppercase tracking-widest font-medium">Bloqueio Criativo</div>
            </div>
            <div className="flex-1 md:border-l md:border-zinc-200 md:pl-8">
              <div className="text-4xl font-bold text-black mb-1">Scale</div>
              <div className="text-xs text-zinc-500 uppercase tracking-widest font-medium">Personalização em Massa</div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-20">
          <h2 id="anatomia" className="font-bold text-zinc-900 mb-8">Framework Universal de Prompt (R.T.C.F.)</h2>
          <p className="text-zinc-700 mb-8">Antes de digitar qualquer coisa, pense nestes 4 componentes.</p>
        ...
        <div className="mb-20">
          <h2 id="templates" className="font-bold text-zinc-900 mb-10">Biblioteca de Prompts Prontos</h2>
            ...
            {templates.map((template, index) => (
              <div key={index} className="flex flex-col h-full">
                <div className="mb-4 border-b border-black pb-2">
                  ...
                  <div className="text-xs text-zinc-500 font-mono mt-1">{template.subject}</div>
                </div>
                <div className="flex-1 bg-zinc-50 p-6 rounded-sm text-sm font-mono text-zinc-800 whitespace-pre-wrap leading-relaxed border border-zinc-200">
                  {template.body}
                </div>
                <div className="mt-4 text-right">
                  <button
                    onClick={() => copyToClipboard(template.body, template.name)}
                    className="text-xs font-bold uppercase tracking-widest text-zinc-900 hover:text-revgreen transition-colors flex items-center gap-2 justify-end bg-white p-2 border border-zinc-200 rounded-sm ml-auto"
                  >
