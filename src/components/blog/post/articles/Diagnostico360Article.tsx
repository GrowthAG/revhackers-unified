    ...
    return (
        <article className="w-full mx-auto">
            ...
            <div className="prose prose-base md:prose-lg lg:prose-xl max-w-none text-zinc-900 leading-relaxed">
                ...
                <div className="mb-16">
                    <h2 id="intro" className="font-bold tracking-tight text-zinc-900 mt-0">O Sintoma vs A Doença</h2>
                ...
                <div className="mb-20">
                    <h2 className="font-bold text-zinc-900 mb-8">Os 4 Pilares do Diagnóstico</h2>
                    <div className="grid md:grid-cols-2 gap-6 not-prose">
                        <Card className="p-6 border-l-4 border-l-revgreen">
                            ...
                            <p className="text-sm text-zinc-600">Existe um playbook claro? O time segue? As etapas do funil estão bem definidas?</p>
                        </Card>
                        <Card className="p-6 border-l-4 border-l-revgreen">
                            <h3 className="font-bold text-lg mb-2 flex items-center gap-2"><BarChart3 className="w-5 h-5" /> Métricas</h3>
                            <p className="text-sm text-zinc-600">Você sabe seu CAC, LTV e Taxas de Conversão entre etapas? Sem isso, você voa no escuro.</p>
                        </Card>
                        <Card className="p-6 border-l-4 border-l-revgreen">
                            <h3 className="font-bold text-lg mb-2 flex items-center gap-2"><AlertTriangle className="w-5 h-5" /> Pessoas</h3>
                            <p className="text-sm text-zinc-600">O time tem as skills necessárias? A compensação incentiva o comportamento certo?</p>
                        </Card>
                        <Card className="p-6 border-l-4 border-l-revgreen">
                            <h3 className="font-bold text-lg mb-2 flex items-center gap-2"><Search className="w-5 h-5" /> Tecnologia</h3>
                            <p className="text-sm text-zinc-600">As ferramentas estão integradas? Os dados fluem ou ficam em silos?</p>
                        </Card>
                    </div>
                </div>
