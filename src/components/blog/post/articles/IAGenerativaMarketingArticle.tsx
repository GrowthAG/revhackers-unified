    ...
    return (
        <article className="max-w-4xl mx-auto px-6 py-12 font-sans text-zinc-900 leading-relaxed">
            ...
            <div className="mb-12 p-8 border-l-2 border-black">
                <h3 className="text-xs font-bold uppercase tracking-widest text-zinc-500 mb-4 flex items-center">
            ...
            <section className="mb-16">
                <h2 className="text-3xl font-bold mb-6 text-zinc-900 tracking-tight">A Anatomia de um Agente de Growth</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-zinc-200 divide-y md:divide-y-0 md:divide-x divide-gray-200">
            ...
            <section className="mb-16 border border-zinc-200 p-8 md:p-12 bg-zinc-50">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                    <div>
                        <span className="text-xs font-bold text-zinc-400 uppercase tracking-widest block mb-2">Blueprint #01</span>
                        <h2 className="text-2xl md:text-3xl font-bold text-zinc-900 tracking-tight">A Máquina de Conteúdo Infinito</h2>
                    </div>
                </div>
                ...
                <div className="space-y-0 text-sm border border-zinc-200 bg-white">
                    <div className="flex items-start p-4 border-b border-zinc-100">
                        <span className="font-mono font-bold text-black w-24 shrink-0">Trigger]</span>
                        <span className="text-zinc-600">Novo arquivo de vídeo upado no Google Drive</span>
                    </div>
                    <div className="flex items-start p-4 border-b border-zinc-100 bg-zinc-50/50">
                        <span className="font-mono font-bold text-black w-24 shrink-0">Agent 1]</span>
                        <span className="text-zinc-600"><strong>Transcritor:</strong> Usa Whisper AI para converter áudio em texto com &gt;98% de precisão.</span>
                    </div>
                    <div className="flex items-start p-4 border-b border-zinc-100">
                        <span className="font-mono font-bold text-black w-24 shrink-0">Agent 2]</span>
                        <span className="text-zinc-600"><strong>Analista:</strong> Identifica 3 temas virais, extrai key takeaways e citações memoráveis.</span>
                    </div>
                    <div className="flex items-start p-4 border-b border-zinc-100 bg-zinc-50/50">
                        <span className="font-mono font-bold text-black w-24 shrink-0">Agent 3]</span>
                        <span className="text-zinc-600"><strong>Editor:</strong> Escreve 1 Artigo de Blog (SEO), 5 Posts LinkedIn (Carrossel/Texto), 1 Newsletter.</span>
                    </div>
                    <div className="flex items-start p-4">
                        <span className="font-mono font-bold text-revgreen w-24 shrink-0">Action]</span>
                        <span className="text-zinc-600">Salva rascunhos no Notion/CMS prontos para revisão humana.</span>
                    </div>
                </div>
            ...
            <section className="mb-16">
                <h2 className="text-3xl font-bold mb-6 text-zinc-900 tracking-tight">Blueprint #02: O Pesquisador SDR Autônomo</h2>
                <p className="text-lg text-zinc-600 mb-8 font-light">
                    SDRs humanos perdem 40% do tempo pesquisando sobre o lead antes de ligar. Agentes fazem isso em segundos.
                </p>

                <div className="border-l border-zinc-200 pl-8 space-y-8">
                    <div className="relative">
                        <div className="absolute -left-[37px] top-1.5 w-4 h-4 bg-black rounded-full border-2 border-white"></div>
                        <h4 className="font-bold text-lg text-zinc-900">Passo 1: Enriquecimento Contextual</h4>
                    ...
                    <div className="relative">
                        <div className="absolute -left-[37px] top-1.5 w-4 h-4 bg-zinc-200 rounded-full border-2 border-white"></div>
                        <h4 className="font-bold text-lg text-zinc-900">Passo 2: Mapeamento de Decisores</h4>
                        <p className="text-zinc-600 mt-2 text-sm leading-relaxed">
                    ...
                    <div className="relative">
                        <div className="absolute -left-[37px] top-1.5 w-4 h-4 bg-zinc-200 rounded-full border-2 border-white"></div>
                        <h4 className="font-bold text-lg text-zinc-900">Passo 3: Hiper-Personalização</h4>
                        <p className="text-zinc-600 mt-2 text-sm leading-relaxed">
            ...
            {/* The Tech Stack */}
            <section className="mb-16 border border-zinc-200 p-8">
                <h2 className="text-xl font-bold mb-6 text-zinc-900 flex items-center tracking-tight">
                    <Code className="w-5 h-5 mr-3 text-black" />
                    A Stack Técnica Mínima Viável
                </h2>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-0 divide-x divide-gray-100 border border-zinc-100">
                    <div className="p-4 text-center">
                        <span className="block font-bold text-zinc-900 mb-1 text-sm">Orquestrador</span>
                        <span className="text-xs text-zinc-500 font-mono">LangChain / n8n</span>
                    </div>
                    <div className="p-4 text-center">
                        <span className="block font-bold text-zinc-900 mb-1 text-sm">Cérebro (LLM)</span>
                        <span className="text-xs text-zinc-500 font-mono">OpenAI GPT-4o</span>
                    </div>
                    <div className="p-4 text-center">
                        <span className="block font-bold text-zinc-900 mb-1 text-sm">Memória</span>
                        <span className="text-xs text-zinc-500 font-mono">Pinecone / Supabase</span>
                    </div>
                    <div className="p-4 text-center">
                        <span className="block font-bold text-zinc-900 mb-1 text-sm">Ferramentas</span>
                        <span className="text-xs text-zinc-500 font-mono">SerpApi / Zapier</span>
                    </div>
                </div>
            </section>
            ...
            <section className="mb-16">
                <h2 className="text-3xl font-bold mb-8 text-zinc-900 tracking-tight">Como implementar sem quebrar a operação</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-black rounded-sm overflow-hidden">
                    <div className="p-8 bg-white border-b md:border-b-0 md:border-r border-zinc-200">
                        ...
                        <p className="text-sm text-zinc-500 leading-relaxed">Humanos fazendo o trabalho, com IA dando suporte (Brainstorming, Revisão). Risco zero, ganho de 20% produtividade.</p>
                    </div>
                    <div className="p-8 bg-white border-b md:border-b-0 md:border-r border-zinc-200">
                        ...
                        <p className="text-sm text-zinc-500 leading-relaxed">Tasks repetitivas e lineares delegadas para Scripts/Zaps. Ex: Transcrição de call, Envio de ata.</p>
                    </div>
                    <div className="p-8 bg-black text-white">
                        <span className="text-4xl font-black text-zinc-700 block mb-4">03</span>
                        <h4 className="font-bold text-lg mb-2 text-white">Agentes (Mês 3)</h4>
                        <p className="text-sm text-zinc-400 leading-relaxed">Sistemas que tomam decisões. Ex: SDR Autônomo que decide quem prospectar.</p>
                    </div>
                </div>
            </section>
