  ...
  return (
    <article className="w-full mx-auto">
      <div className="prose prose-base md:prose-lg lg:prose-xl max-w-none text-zinc-900 leading-relaxed">
        ...
        {/* Intro + Stats */}
        <div className="mb-16">
          <h2 id="intro" className="font-bold tracking-tight text-zinc-900 mt-0">A Era da Autoridade Digital</h2>
          ...
          <div className="flex flex-col md:flex-row gap-8 my-10 border-y border-zinc-200 py-8 not-prose">
            <div className="flex-1">
              ...
              <div className="text-xs text-zinc-500 uppercase tracking-widest font-medium">Oportunidades Inbound</div>
            </div>
            <div className="flex-1 md:border-l md:border-zinc-200 md:pl-8">
              <div className="text-4xl font-bold text-black mb-1">92%</div>
              <div className="text-xs text-zinc-500 uppercase tracking-widest font-medium">Aumento de Autoridade</div>
            </div>
            <div className="flex-1 md:border-l md:border-zinc-200 md:pl-8">
              <div className="text-4xl font-bold text-black mb-1">43%</div>
              <div className="text-xs text-zinc-500 uppercase tracking-widest font-medium">Maior Ticket Médio</div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-20">
          <h2 id="anatomia" className="font-bold text-zinc-900 mb-8">O Framework PLG (4 Pilares)</h2>
          <p className="text-zinc-700 mb-8">Uma metodologia para transformar "likes" em contratos assinados.</p>
        ...
        {/* Templates Grid */}
        <div className="mb-20">
          <h2 id="templates" className="font-bold text-zinc-900 mb-10">Templates de Implementação</h2>
              ...
              <div key={index} className="flex flex-col h-full">
                ...
                <div className="mt-4 text-right">
                  <button
                    ...
                    className="text-xs font-bold uppercase tracking-widest text-zinc-900 hover:text-revgreen transition-colors"
                  >
