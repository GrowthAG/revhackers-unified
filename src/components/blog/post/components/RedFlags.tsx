...
const RedFlags = ({ flags, title = "Sinais de Alerta: Onde a maioria erra" }: RedFlagsProps) => {
    return (
        <div className="my-16 bg-zinc-50 p-8 not-prose border-l-2 border-black/10">
            ...
            <ul className="space-y-4 m-0">
                {flags.map((flag, index) => (
                    <li key={index} className="flex items-start gap-4 text-zinc-600 text-sm leading-relaxed">
