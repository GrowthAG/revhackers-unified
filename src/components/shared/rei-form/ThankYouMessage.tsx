    ...
    <Card className="max-w-3xl mx-auto bg-black border border-zinc-800 p-12 text-center rounded-2xl shadow-sm overflow-hidden relative">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10 text-left w-full max-w-xl">
          <div className="bg-zinc-900/50 border border-zinc-800 p-5 rounded-xl flex items-start space-x-4">
            <div className="bg-black p-2 rounded-lg mt-1 border border-zinc-800">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
          <Button
            asChild
            className="bg-revgreen text-black font-bold px-8 py-6 rounded-lg hover:bg-revgreen/90 transition-all text-sm uppercase tracking-wider w-full sm:w-auto hover:scale-105"
          >
