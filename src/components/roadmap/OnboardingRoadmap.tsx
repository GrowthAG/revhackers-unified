        ...
        <section className="space-y-8" id="onboarding-roadmap">
            <div className="text-center space-y-4">
                <div className="flex items-center justify-center gap-2 mb-2">
                    ...
                    <h3 className="text-[11px] font-bold text-emerald-600 uppercase tracking-[0.2em]">Metodologia Exclusiva</h3>
                </div>
            ...
            <div className="relative pt-8 pb-4">
                ...
                <div className="hidden lg:block absolute top-[45px] left-0 w-full h-[2px] bg-gradient-to-r from-zinc-100 via-zinc-200 to-zinc-100 z-0"></div>
                    ...
                    {stages.map((stage, index) => {
                        ...
                        return (
                            <div key={stage.id} className="group relative flex flex-col items-center text-center space-y-4">
                                ...
                                {/* Icon Circle */}
                                <div className="w-14 h-14 rounded-full bg-white border border-zinc-200 shadow-sm flex items-center justify-center group-hover:border-emerald-500 group-hover:shadow-md transition-all duration-300 relative z-10">
                                    <Icon className="w-6 h-6 text-zinc-400 group-hover:text-emerald-600 transition-colors" strokeWidth={1.5} />

                                    {/* Number Badge */}
                                    <div className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-zinc-100 border border-white flex items-center justify-center text-[10px] font-bold text-zinc-500 group-hover:bg-emerald-500 group-hover:text-white transition-colors">
                                        {stage.id}
                                    </div>
                                </div>
                                ...
                                <div className="space-y-1.5 px-2">
                                    <span className="text-[10px] font-mono uppercase tracking-wider text-emerald-600/80 bg-emerald-50/50 px-2 py-0.5 rounded-full">
                                        {stage.duration}
                                    </span>
