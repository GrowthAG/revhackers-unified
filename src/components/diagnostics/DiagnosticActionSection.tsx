                ...
                <div className="text-center bg-zinc-50 p-12 md:p-20 border border-zinc-100">
                    <div className="max-w-3xl mx-auto space-y-12">
                        <div className="space-y-6">
                            <span className="text-xxs font-mono font-black text-zinc-400 uppercase tracking-[0.5em]">NEXT // ACTION_PLAN</span>
                        ...
                        <div className="flex flex-col items-center gap-8">
                            <a
                                ...
                                className="group relative px-20 py-8 bg-zinc-900 text-white hover:bg-zinc-800 font-black uppercase tracking-[0.3em] text-xs transition-all duration-500 rounded-none overflow-hidden shadow-sm cursor-pointer"
                            >
                                <span className="relative z-10 flex items-center gap-4">
                                    {ctaText} <ArrowRight className="w-5 h-5 group-hover:translate-x-2 transition-transform" />
                                </span>
                            </a>
                            <div className="flex items-center gap-4 text-xxs text-zinc-400 uppercase tracking-[0.2em] font-black">
