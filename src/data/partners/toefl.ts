...
export const toeflData: PartnerData = {
  ...
  caseStudy: [
    "O TOEFL Junior Brasil buscava estratégias para gerar leads B2B de donos de escolas interessados em implementar o sistema TOEFL em suas instituições. O principal desafio era alcançar diretamente os tomadores de decisão das escolas e apresentar os benefícios do programa.",
