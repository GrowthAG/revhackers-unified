...
export const funnelsCase: CaseStudy = {
  ...
  results: [
    "Agenda de vendas lotada apenas com leads orgânicos do LinkedIn, sem depender de cold outbound ou anúncios",
    "Aumento de 130% em leads qualificados (C-Level e Diretores) através de conteúdo e engenharia social no LinkedIn",
    "Autoridade estabelecida no nicho de Automação de Vendas: perfil alcançou Top 1% Social Selling Index",
    "Zero dependência de anúncios pagos para fechar novos contratos no primeiro trimestre, com ciclo de vendas 40% menor"
  ],
  metrics: [
    {
      value: "+130%",
  ...
  logoScale: 1.5,
  techStack: ["LinkedIn Sales Nav", "Taplio", "Apollo.io", "Funnels"]
};
