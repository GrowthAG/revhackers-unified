...
export const agenceMrCase = {
  ...
  authorImage: "https://storage.googleapis.com/msgsndr/oFTw9DcsKRUj6xCiq4mb/media/694f30d2afc5431194b4e3f0.png",
  preview_description: "Otimização consultiva de tráfego pago: Como a reestruturação das campanhas de Google Ads e a integração de dados reduziram o CPA em 40% e aumentaram o ticket médio.",
  logoScale: 1.5,
  techStack: ["Google Ads", "Meta Ads", "Google Analytics 4", "Looker Studio"]
};
