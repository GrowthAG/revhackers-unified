            ...
            <div className="my-auto px-6 md:px-10 lg:px-12 py-8 max-w-[1600px] mx-auto w-full">
                ...
                <div className="mt-12">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
                        ...
                        <div className="flex flex-col relative group">
                            ...
                            <div className="mb-6 flex items-center justify-between">
                                <span className="inline-flex items-center justify-center h-8 px-4 border border-zinc-200 text-zinc-400 font-mono text-xxs uppercase font-bold tracking-widest">
                                    Revisão Executiva
                                </span>
                            </div>
                            ...
                            <p className="text-sm text-zinc-500 leading-relaxed font-medium flex-1">
                                <EditableField
                            ...
                            <div className="mt-6 pt-4 border-t border-zinc-100 flex items-center gap-3">
                                <span className="text-2xs font-bold uppercase tracking-[0.2em] text-[#00CC6A] bg-[#00CC6A]/10 px-2 py-0.5 rounded">
                                    Entregável
                                </span>
                                <span className="text-xs font-bold text-zinc-800">Relatório Trimestral de Resultados (QBR)</span>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col relative group">
                            ...
                            <div className="mt-6 pt-4 border-t border-zinc-100 flex items-center gap-3">
                                <span className="text-2xs font-bold uppercase tracking-[0.2em] text-zinc-500 border border-zinc-200 px-2 py-0.5 rounded">
                                    Mudança
                                </span>
                                <span className="text-xs font-bold text-zinc-800">De "Construtores" para "Otimizadores"</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-16 pt-8 border-t border-zinc-100 flex items-start gap-4 max-w-2xl">
                        ...
                        <p className="text-base text-zinc-800 font-bold leading-relaxed">
                            "
                            <EditableField
