...
export default function InvestmentSection({ proposal }: { proposal: any }) {
    ...
    const acceptanceLink = proposal?.crm_data?.payment_link || 'https://revhackers.com/onboarding';
            ...
            <div className="w-full max-w-6xl mx-auto flex flex-col z-10">
                ...
                <div className="flex flex-col lg:flex-row shadow-2xl rounded-2xl overflow-hidden border border-zinc-800">
                        ...
                        <div className="space-y-8">
                            <div className="flex justify-between items-end group">
                                <div>
                                    ...
                                    <span className="text-xs text-zinc-500 font-light">Taxa única de arquitetura e onboarding técnico.</span>
                                </div>
                                <span className="text-2xl font-bold text-white group-hover:text-[#00CC6A] transition-colors whitespace-nowrap">
                                    <span className="text-sm text-zinc-500 mr-1">R$</span>
                                    <EditableField path="setup_fee" placeholder="0" />
                                </span>
                            </div>
                            ...
                            <div className="flex justify-between items-end group">
                                <div>
                                    ...
                                    <span className="text-xs text-zinc-500 font-light">Manutenção, inteligência e servidores. Parcelas sucessivas.</span>
                                </div>
                                <span className="text-2xl font-bold text-white group-hover:text-[#00CC6A] transition-colors whitespace-nowrap">
                                    <span className="text-sm text-zinc-500 mr-1">R$</span>
                                    <EditableField path="installment_value" placeholder="0" />
                                </span>
                            </div>
                        </div>
                    ...
                    <div className="flex-[2] bg-white p-10 lg:p-16 flex flex-col items-center justify-center text-center relative overflow-hidden group">
                        ...
                        <p className="text-xs uppercase tracking-[0.2em] font-black text-zinc-400 mt-2 relative z-10 flex items-center justify-center">
                            Aponte a Câmera <ArrowRight className="w-3 h-3 ml-2 text-[#00CC6A]" />
                        </p>
