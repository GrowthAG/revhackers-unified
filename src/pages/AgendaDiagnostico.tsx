      ...
      <section className="py-16 bg-black text-white">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">O que você receberá no diagnóstico</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <Card className="relative bg-black p-6 rounded-xl border border-white/10 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-bold text-xl mb-3 text-white">Diagnóstico Completo</h3>
              ...
              <Card className="relative bg-black p-6 rounded-xl border border-white/10 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-bold text-xl mb-3 text-white">Estratégias Personalizadas</h3>
                  <p className="text-white/80">
              ...
              <Card className="relative bg-black p-6 rounded-xl border border-white/10 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-bold text-xl mb-3 text-white">Plano de Ação</h3>
                  <p className="text-white/80">
