        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto bg-white p-8 shadow-sm">
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              ...
              <h2 className="text-2xl font-semibold text-zinc-800">1. Informações que Coletamos</h2>
              ...
              <h2 className="text-2xl font-semibold text-zinc-800">2. Como Usamos Suas Informações</h2>
              <p className="text-zinc-700 leading-relaxed">
              ...
              <h2 className="text-2xl font-semibold text-zinc-800">3. Compartilhamento de Informações</h2>
              <p className="text-zinc-700 leading-relaxed">
              ...
              <h2 className="text-2xl font-semibold text-zinc-800">4. Cookies e Tecnologias Semelhantes</h2>
              <p className="text-zinc-700 leading-relaxed">
              ...
              <h2 className="text-2xl font-semibold text-zinc-800">5. Segurança</h2>
              <p className="text-zinc-700 leading-relaxed">
              ...
              <h2 className="text-2xl font-semibold text-zinc-800">6. Seus Direitos</h2>
              <p className="text-zinc-700 leading-relaxed">
              ...
              <h2 className="text-2xl font-semibold text-zinc-800">7. Retenção de Dados</h2>
              <p className="text-zinc-700 leading-relaxed">
              ...
              <h2 className="text-2xl font-semibold text-zinc-800">8. Links para Sites de Terceiros</h2>
              <p className="text-zinc-700 leading-relaxed">
                Nosso site pode conter links para sites de terceiros. Não somos responsáveis 
                pelas práticas de privacidade desses sites.
              </p>
              
              <h2 className="text-2xl font-semibold text-zinc-800">9. Alterações na Política de Privacidade</h2>
              <p className="text-zinc-700 leading-relaxed">
              ...
              <div className="text-sm text-zinc-500 mt-12 pt-6 border-t border-zinc-200">
